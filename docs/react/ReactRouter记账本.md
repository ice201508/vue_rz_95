...
![image.png](assets4/15.png)

4.  访问接口进行测试 
# 整体路由设计
![image.png](assets4/16.png)
1. 俩个一级路由 （Layout / new）2. 俩个二级路由 （Layout - mouth/year）

# antD主题定制
## 1. 定制方案
![image.png](assets4/17.png)
## 2. 实现方式

1. 全局定制

![image.png](assets4/18.png)

2. 局部定制

![image.png](assets4/19.png)
